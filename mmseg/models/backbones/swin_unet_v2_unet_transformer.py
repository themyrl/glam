...
from ..utils.swin_unet_v2_unet_transformer_utils import SwinTransformerUNetTransformerUpsampleSys
...
class SwinUNetV2UNetTransformer(nn.Module):
    def __init__(self, pretrain_img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.swin_unet = SwinTransformerUNetTransformerUpsampleSys(pretrain_img_size=pretrain_img_size,
