...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, gt_num=1, id_layer=0, do_gt_att=True):
        super().__init__()
        self.dim = dim
        self.gt_num = gt_num
        self.num_heads = num_heads
...
class BasicLayer(nn.Module):
    ...
    def __init__(self,
        ...
        # build blocks
        do_gt_att = [True for i in range(depth)]
        do_gt_att[-1] = False
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(
                ...
                norm_layer=norm_layer, gt_num=gt_num,id_layer=id_layer, do_gt_att=do_gt_att[i])
...
class SwinTransformerGTV8Opti(nn.Module):
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformerGTV8Opti, self).train(mode)
        self._freeze_stages()
